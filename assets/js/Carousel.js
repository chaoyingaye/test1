var Carousel=(function () {
    ...
    Carousel.prototype={
        ...
        finishLoad:function (list) {
            ...
            this.imageList[0].style.float="left";
            if(this.width===0){
        ...
        createNextImg:function () {
            ...
            if(this.width!==0){
                ...
                this.imageList[this.position].style.float="left";
            }
            if(this.height!==0){
        ...
        changeDot:function () {
            if(this.preDot){
                this.preDot.style.backgroundColor="#fff";
            }
            this.preDot=this.carousel.lastElementChild.children[this.position];
            this.preDot.style.backgroundColor="#6faa22";
        }
    };
